...
const CONTEXT_LINES = 3; // How many unchanged lines to show around a change
...
/**
 * Groups flat diff lines into "chunks" that can be folded
 */
...
const ComparisonView = ({ pair }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0d1117] overflow-hidden animate-in fade-in duration-300">
    ...
    for (let i = 0; i < files.length; i += batchSize) {
      ...
      const results = await Promise.all(batch.map(async (file) => {
        ...
        return new Promise((resolve) => {
          ...
          // Catch potential binary reading errors
            ...
            <div className="px-5 py-4 border-b border-white/5 space-y-4">
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-[#010409] border border-white/10 rounded-lg py-2 pl-9 pr-4 text-xs outline-none focus:border-blue-500/50 transition-all placeholder:text-slate-600"
                  value={searchTerm}
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-12 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-slate-500 text-sm max-w-sm mx-auto leading-relaxed mb-10 font-medium">
                Select directories to begin a deep-link comparison. Large unchanged code blocks are automatically folded to prioritize your focus on actual changes.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-3xl">
                {[
                  { icon: Eye, color: 'text-blue-400', label: 'Chunking', text: 'Folding unchanged blocks' },
